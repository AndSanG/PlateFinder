...
let plateInfoURL = URL(string: "https://consultaweb.ant.gob.ec/PortalWEB/paginas/clientes/clp_grid_citaciones.jsp?ps_tipo_identificacion=PLA&ps_identificacion=ABC2234&ps_placa=")!
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function facturas(p_opcion){
                ...
                gs_opcion=p_opcion;
                $("#list10").setGridParam(
                {datatype:'json', url:"clp_json_citaciones.jsp?ps_opcion="+p_opcion+"&ps_id_contrato=102276518&ps_id_persona=2563423&ps_placa=ABC1234&ps_identificacion=ABC1234&ps_tipo_identificacion=PLA",
                    page:1
                }
            ).trigger("reloadGrid");
                ...
                //actualiza_estado_cuenta("2563423",p_opcion);
            }
    ...
    <body>
        ...
        <div id="IFrameDivPuntos"   title="Detalle de Puntos" style="display:none;" >
            <iframe id ="iframe_puntos" src="clp_grid_puntos.jsp?ps_id_persona=2563423" frameborder="10"
        ...
        <table width="1100" border="0" cellspacing="1" cellpadding="2">
            ...
            <tr>
                <td width="200" rowspan="4" align="center" valign="middle" bgcolor="#FFFFFF" class="titulo2"><strong>ABC1234</strong></td>
                <td class="titulo">Marca:</td>
                <td class="detalle_formulario">TOYOTA</td>
                <td class="titulo">Color:</td>
                <td class="detalle_formulario">AMARILLO</td>
                <td class="titulo">A&ntilde;o de Matr&iacute;cula</td>
                <td class="detalle_formulario">2025</td>
            ...
            <tr>
                ...
                <td class="detalle_formulario">AA COROLLA 1.6</td>
                <td class="titulo">Clase:</td>
                <td class="detalle_formulario">AUTOMOVIL</td>
                <td class="titulo">Fecha de Matr&iacute;cula:</td>
                <td class="detalle_formulario">14-06-2025</td>
            </tr>
            <tr>
               
                <td  class="titulo">A&ntilde;o:</td>
                <td class="detalle_formulario">2009</td>
                <td  class="titulo">Servicio:</td>
                <td  class="detalle_formulario">USO PUBLICO</td>
                <td class="titulo">Fecha de Caducidad:</td>
                <td class="detalle_formulario">31-05-2030</td>
                
               
            </tr>
            <tr>
                       
                <td class="titulo"> Polarizado: </td>
                <td  class="detalle_formulario" > <font color = "#FF0000"  > No existe registro de polarizado</td>
                <td class="titulo" > Fecha Caducidad: </td>
                <td class="detalle_formulario">  <font color = "#FF0000"  ></td>
            </tr
        ...
        <div id="div_estado_cuenta" align="left" >
            <iframe id ="iframe_estado_cuenta"
                    src="clp_estado_cuenta.jsp?ps_persona=2563423&ps_id_contrato=102276518&ps_opcion=P&ps_placa=ABC1234&ps_identificacion=ABC1234&ps_tipo_identificacion=PLA"
                    frameborder="0"
        ...
        <script>
            ...
            var mygrid =     jQuery("#list10").jqGrid({
                url:'clp_json_citaciones.jsp?ps_opcion=P&ps_id_contrato=102276518&ps_id_persona=2563423&ps_placa=ABC1234&ps_identificacion=ABC1234&ps_tipo_identificacion=PLA',
